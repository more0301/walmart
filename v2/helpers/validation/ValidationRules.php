    ...
    private function setRules(string $name)
    {
        switch ($name) {
            ...
            case 'price':
                return [
                    'type'      => 'float',
                    'min_value' => App::$options['shops'][App::$shopId]['min_price']
                ];
            ...
            case 'inventory_amount':
                return [
                    'type'         => 'int',
                    'max_value'    => App::$options['shops'][App::$shopId]['max_inventory_quantity'],
                    'min_value'    => App::$options['shops'][App::$shopId]['min_inventory_quantity'],
                    'allowed_zero' => true
                ];
            case 'inventory_fulfillment':
                return [
                    'type'  => 'int',
                    'equal' => App::$options['shops'][App::$shopId]['inventory_fulfillment']
                ];
